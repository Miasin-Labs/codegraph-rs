...
use crate::resolution::resolver::context::{
    is_js_ts_language,
    is_low_value_js_ts_resolution_source,
};
use crate::resolution::resolver::engine::ResolutionPolicy;
use crate::resolution::resolver::policy::{
...
impl ResolutionPolicy for SnapshotContext {
    ...
    fn has_any_possible_match_ci(&self, name: &str) -> bool {
        ...
        let probe = |value: &str| !self.get_nodes_by_lower_name(value).is_empty();
        if probe(&lower) {
            return true;
        }
