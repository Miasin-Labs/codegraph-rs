//! Web-framework route detection — codegraph-analysis parity with codegraph's `route`
//! nodes.
//!
//! codegraph emits dedicated `route` nodes for web-framework route
//! registrations (k8s 57, terraform 34 in the reference study); codegraph-analysis had
